...
function Navbar() {
  return (
    <div
      className="container mx-auto flex flex-wrap gap-10 border-b-2 border-cyan-600 pb-6 pt-6 text-center text-cyan-600"
      // background pattern
      style={{
    ...
    >
      ...
      <div className="flex basis-full justify-around font-bold sm:text-xl md:text-2xl ">
