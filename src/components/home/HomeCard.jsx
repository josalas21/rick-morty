function HomeCard({ subtitle, content, img }) {
  return (
    <div
      class="flex h-[34rem] w-[20rem] flex-wrap rounded-[3rem] border border-cyan-600 shadow-sm shadow-cyan-500 md:h-[38rem] md:w-[23rem]"
      // background pattern
      style={{
    ...
    >
      <img
        class="h-[13rem] w-[20rem] rounded-t-[3rem] md:h-[15rem] md:w-[23rem] "
        src={img}
        alt="image"
      />
      <div class="p-5 text-justify text-sm md:text-base">
        <h3 class="pb-4 text-center text-xl font-bold tracking-tight text-cyan-800 md:mb-2 md:text-2xl ">
          {subtitle}
        </h3>
